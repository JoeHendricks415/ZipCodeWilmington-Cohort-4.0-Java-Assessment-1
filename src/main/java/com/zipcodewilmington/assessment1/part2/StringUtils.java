...
public class StringUtils {
    ...
    public static String[] getWords(String sentence) {
        ...
        String[] array = sentence.split(" ", sentence.length());
    ...
    public static String reverseFirstWord(String sentence) {
        ...
        for(int i = firstWord.length() - 1; i >= 0; i--){
            reverseFirstWord = reverseFirstWord + firstWord.charAt(i);
        }
    ...
    public static String reverseFirstWordThenCamelCase(String sentence) {
        ...
        reverseFirstWord = Character.toUpperCase(reverseFirstWord.charAt(0)) + reverseFirstWord.substring(1);
    ...
    public static String removeCharacterAtIndex(String str, int index) {
        ...
        StringBuilder removeIndex = new StringBuilder(str);

        removeIndex.deleteCharAt(index);

        return removeIndex.toString();
    }
